...
import numpy as np
from visualization import vis_from_point, hk_Visualization
...
new_vis_point = hk_Visualization(v, t_ls, math.radians(36.10747996))
vis_from_point(h, s, vis_point, new_vis_point)